...
<p>考虑一个二叉树的所有叶子。这些叶子的值按从左到右的顺序排列形成一个&nbsp;<em>叶值序列</em> 。</p>

<p><img alt="" src="https://s3-lc-upload.s3.amazonaws.com/uploads/2018/07/16/tree.png" style="height: 240px; width: 300px;"></p>

<p>举个例子，给定一个如上图所示的树，其叶值序列为&nbsp;<code>(6, 7, 4, 9, 8)</code>&nbsp;。</p>

<p>如果两个二叉树的叶值序列相同，我们就认为它们是&nbsp;<em>叶相似的</em>。</p>

<p>如果给定的两个头结点分别为&nbsp;<code>root1</code> 和&nbsp;<code>root2</code>&nbsp;的树是叶相似的，返回&nbsp;<code>true</code>；否则返回 <code>false</code> 。</p>
...
<ul>
	<li>给定的两个树会有&nbsp;<code>1</code>&nbsp;到&nbsp;<code>100</code>&nbsp;个结点。</li>
</ul>
<p>考虑一个二叉树的所有叶子。这些叶子的值按从左到右的顺序排列形成一个&nbsp;<em>叶值序列</em> 。</p>
