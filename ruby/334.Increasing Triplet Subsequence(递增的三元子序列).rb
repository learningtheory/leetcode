...
<p><b>Credits:</b><br />Special thanks to <a href="https://leetcode.com/discuss/user/DjangoUnchained">@DjangoUnchained</a> for adding this problem and creating all test cases.</p><p>给定一个未排序的数组，请判断这个数组中是否存在长度为3的递增的子序列。</p>
...
<p><strong>说明:</strong> 要求算法时间复杂度为O(<em>n</em>)，空间复杂度为O(<em>1</em>) 。</p>
...
<p>给定一个未排序的数组，请判断这个数组中是否存在长度为3的递增的子序列。</p>
