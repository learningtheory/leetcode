...
<p><b>Credits:</b><br />Special thanks to <a href="https://discuss.leetcode.com/user/elmirap">@elmirap</a> for adding this problem and creating all test cases.</p><p>给定一个正整数 <em>num</em>，编写一个函数，如果 <em>num</em> 是一个完全平方数，则返回 True，否则返回 False。</p>
...
<p>特别感谢 <a href="https://discuss.leetcode.com/user/elmirap">@elmirap</a> 添加此问题并创建所有测试用例。</p>
