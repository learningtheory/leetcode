...
<p><b>Credits:</b><br />Special thanks to <a href="https://leetcode.com/agave/">@agave</a> and <a href="https://leetcode.com/stefanpochmann/">@StefanPochmann</a> for adding this problem and creating all test cases.</p><p>我们正在玩一个猜数游戏，游戏规则如下：</p>
...
<p>给定一个 <strong>n &ge; 1，</strong>计算你至少需要拥有多少现金才能确保你能赢得这个游戏。</p>

<p><strong>致谢:</strong></p>

<p>特别感谢 <a href="https://leetcode.com/agave/">@agave</a>&nbsp;和&nbsp;<a href="https://leetcode.com/stefanpochmann/">@StefanPochmann</a>&nbsp;添加了这道题目，并且提供了所有测试用例。</p>
