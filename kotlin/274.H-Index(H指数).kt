...
<p><a href="https://baike.baidu.com/item/h-index/3991452?fr=aladdin" target="_blank">h 指数的定义</a>: &ldquo;一位有&nbsp;<em>h</em>&nbsp;指数的学者，代表他（她）的<em> N</em> 篇论文中<strong>至多</strong>有<em> h </em>篇论文，分别被引用了<strong>至少</strong>&nbsp;<em>h</em> 次，其余的&nbsp;<em>N - h&nbsp;</em>篇论文每篇被引用次数<strong>不多于 </strong><em>h </em>次。&rdquo;</p>
